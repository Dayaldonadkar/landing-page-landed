      ...
      <section className='bg-white'>
        <nav className='flex justify-between p-6 px-4'>
          ...
          <div className='hidden xl:flex items-center'>
            ...
            <a
              className='inline-block py-2 px-4 text-sm leading-5 text-green-50 bg-coolGray-500 hover:bg-coolGray-600 font-medium focus:ring-2 focus:ring-coolGray-500 focus:ring-opacity-50 rounded-md'
              href='#'
            >
              Contact Us
            </a>
